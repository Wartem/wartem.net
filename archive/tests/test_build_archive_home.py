...
class ArchiveHomeTests(unittest.TestCase):
    ...
    def test_render_root_html_shows_collection_site_buttons(self):
        metadata = {
            "site": {
                "title": "Testarkiv",
                "tagline": "test",
                    ...
                    "entries": [
                        {
                            ...
                            "evidence": [],
                            "wayback_links": [],
                            "local_path": "site-a/site/index.html"
                        },
                        {
                            "slug": "site-b",
                            "title": "Site B",
        ...
        self.assertIn("site-a/site/index.html", html)
        self.assertIn("http://example.com/b", html)
