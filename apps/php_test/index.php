...
/* ngmdhbbh_wartem_db  ngmdhbbh_ nga_artworks */
/* 'www.wartem.se', 185.76.65.40*/

$conn = mysqli_connect(
    'localhost',
    'ngmdhbbh_dbconnecter',
    'postbanken%M',
    'ngmdhbbh_wartem_db',
    '3306'
);
...
/* $db_host        = 'localhost';
$db_user        = 'ngmdhbbh_dbconnecter';
$db_pass        = 'postbanken%M';
$db_database    = 'database';
$db_port        = 'ngmdhbbh_wartem_db'; */

/* mysql -u ngmdhbbh_dbconnecter -h www.wartem.se -p -P 3306 ngmdhbbh_wartem_db */
...
$sql = 'SELECT title FROM nga_artworks WHERE objectid = 18';

$result = mysqli_query($conn, $sql);

$art_work = mysqli_fetch_all($result, MYSQLI_ASSOC);
